        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-gray-600 bg-opacity-20 text-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full py-3 mt-4 bg-teal-500 text-white text-sm sm:text-sm md:text-base lg:text-base font-medium rounded-lg"
